...
$_SESSION['msg']="Thêm chuyên khoa điều trị thành công !";
}
if(isset($_GET['del']))
		  {
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Thêm chuyên khoa</h1>
                            </div>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">chuyên khoa điều trị</h5>
                                            </div>
                                                ...
                                                <form role="form" name="dcotorspcl" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="doctorspecilization"
                                                            class="form-control"
                                                            placeholder="Nhập chuyên khoa điều trị">
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15"><span class="text-bold">Quản lý Chuyên môn bác
                                        sĩ</span></h5>
