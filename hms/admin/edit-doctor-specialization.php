...
$_SESSION['msg']="Cập nhật chuyên khoa điều trị thành công !";
} 
...
<head>
    <title>Admin |Chỉnh sửa chuyên khoa</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Chỉnh sửa chuyên khoa</h1>
                            </div>
                        </div>
                    </section>
                    <!-- end: PAGE TITLE -->
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">Chỉnh sửa chuyên môn của bác sĩ</h5>
                                            </div>
