				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">LỊCH SỬ ĐĂNG KÝ KHÁM CHỮA BỆNH</h1>
								</div>		
							</div>
						</section>
						<!-- end: PAGE TITLE -->
						...
						<div class="container-fluid container-fullw bg-white">						
							<div class="row">
								<div class="col-md-12">									
									...
									<table class="table table-hover text-center" id="sample-table-1">
										<thead>
											<tr>
										...
										<tbody>
											<?php
												$sql=mysqli_query($con,"select * from appointment where userId='".$_SESSION['id_nurse']."'  order by id desc");
												$cnt=1;
