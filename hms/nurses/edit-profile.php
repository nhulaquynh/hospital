			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Cập nhật tài khoản</h1>
							</div>
										...
										<div class="panel panel-white">
											...
											<div class="panel-body">
												...
												?>
													...
													<p><b>Cập nhật ngày </b><?php echo htmlentities($data['creationDate']); ?></p>
													<?php if ($data['updationDate']) { ?>
														<p><b>Khoa điều trị </b><?php echo htmlentities($data['updationDate']); ?></p>
													<?php } ?>
													<hr />
