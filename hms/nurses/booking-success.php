<?php
	// include('include/checkbooking.php');
	// check_booking();
?>
<!DOCTYPE html>
<html lang="en">
										...
										<div class="well profile col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
												<?php
													...
													$get = mysqli_query($con, "SELECT * FROM appointment INNER JOIN doctors WHERE  appointment.doctorId = doctors.id_doctor ORDER BY  appointment.doctorId DESC LIMIT 1");
													...
													function getUsernameFromEmail($email)
														...
														$filename = getUsernameFromEmail($row['Email']);				
