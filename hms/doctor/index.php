...
if (isset($_POST['submit'])) {
	...
	if ($num > 0) {
		...
		$_SESSION['id_doctor'] = $num['id_doctor'];
		$uip = $_SERVER['REMOTE_ADDR'];
		$status = 1;
		$log = mysqli_query($con, "INSERT INTO doctorslog(uid,username,userip,status) VALUES('" . $_SESSION['id_doctor'] . "','" . $_SESSION['dlogin'] . "','$uip','$status')");
