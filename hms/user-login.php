...
if (isset($_POST['submit'])) {
	...
	if ($num > 0) {
		...
		$_SESSION['errmsg'] = "Vui lòng nhập chính xác thông tin!";
...
<head>
	<title>BỆNH NHÂN - ĐĂNG NHẬP</title>
	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			...
			<div class="box-login">
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> APP</span>. <span>All rights reserved</span>
				</div>
