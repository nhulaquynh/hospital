...
<?php
	...
	$query = mysqli_query($con, "UPDATE  appointment SET doctorSpecialization = '',
                                                                                                    doctorId = '$doctorid',
                                                                                                    userId = '$userid',
										...
										<div class="panel panel-white">
											...
											<div class="panel-body">
												...
												<form role="form"  method="post" action="edit-booking.php<?php $_SESSION['id']?>">
													...
													<input type="hidden" value="<?php echo $ex['userId']?>" name="id_user">
														...
														<select name="doctor" class="form-control" id="doctor" onChange="getfee(this.value);" required="required">	
                                                           <?php
                                                                ...
                                                                while($dt = mysqli_fetch_array($sql)){
                                                                    if($ex['doctorId'] == $dt['id_doctor']){
                                                           ?>
                                                                 <option value="<?php echo $ex['doctorId']?>" selected><?php echo $ex['doctorName']?></option>
                                                                 <?php 
                                                                }else{?>
